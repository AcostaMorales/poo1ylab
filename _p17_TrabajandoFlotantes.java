...
public class _p17_TrabajandoFlotantes {
    public static void main(String[] args) {
        ...
        System.out.println(String.format("num1 y num2 en formato flotante con decimal:  %.2f %.3f",num1,num2));
        ...
        System.out.println("\nUso de System.out.printf para formateo de números flotantes: ");
        System.out.printf("num1, num2 en formato flotante:                  %f %f\n",num1,num2);
        System.out.printf("num3, num4 en formato flotante con decimales:    %f %f\n",num3,num4);
        System.out.printf("num4, num5 en formato exponencial:               %e %e\n",num4,num5);
        System.out.printf("num4, num5 en formato exponencial con decimales: %e %e\n",num4,num5);
